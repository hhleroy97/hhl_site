...
export default function TechCard({
  ...
  const desktopPosForFloating =
    titleAlign === 'left'
      ? 'md:left-20 md:right-auto md:translate-x-0'
      : titleAlign === 'center'
  ...
  if (variant === 'floating') {
    return (
      ...
      >
        ...
        <div
          className={`sticky top-0 md:absolute z-20 px-8 py-4 bg-gradient-to-r ${colors.accent} rounded-br-none rounded-bl-none md:rounded-br-lg md:rounded-bl-none shadow-lg flex items-center justify-center w-full max-w-full md:w-auto border-b border-white/10 md:border-b-0 ${desktopPosForFloating}`}
