...
export default function JobCard({
  ...
  return (
    ...
    >
      {/* Company Logo Node */}
      <motion.div
        className='w-24 h-24 rounded-full bg-white backdrop-blur-md border-2 border-white/30 flex items-center justify-center text-2xl mb-8 shadow-xl relative z-10 group-hover:scale-110 transition-transform duration-300'
      ...
      {/* Hover glow effect */}
      <div className='absolute top-0 left-1/2 -translate-x-1/2 w-24 h-24 bg-gradient-to-br from-cyan-500/30 to-purple-500/30 rounded-full opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300'></div>
    </motion.div>
  )
}
