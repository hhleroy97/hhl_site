        ...
        <div className='relative z-10 p-4'>
          ...
          >
            ...
            <div className='flex-1'>
              <h1 className='text-xl lg:text-lg font-bold text-white mb-1 tracking-tight font-display'>
                HARTLEY H. LEROY
              </h1>
              <div className='text-white/80 text-xs lg:text-sm font-medium tracking-wide mb-0.5'>
          ...
          <div className='relative space-y-4'>
            <div className='relative grid grid-cols-1 lg:grid-cols-12 gap-4 lg:items-start'>
              ...
              >
                <div className='relative bg-slate-800/40 border border-white/10 rounded-xl p-3 backdrop-blur-sm'>
                  <div className='relative z-10'>
                    <h2 className='text-primary-400 font-mono text-xs tracking-widest font-semibold mb-3'>
                      CORE SERVICES
                    </h2>
                    ...
                    <div className='space-y-2'>
                      {services.map((service, index) => (
                        <motion.button
                          key={service.id}
                          className={`group w-full text-left relative p-2.5 cursor-pointer transition-all duration-200 rounded-lg border ${
              ...
              >
                <div className='relative bg-slate-800/40 border border-white/10 rounded-xl p-4 backdrop-blur-sm h-[280px] flex flex-col'>
                        ...
                        <div className='flex-1 flex flex-col min-h-0'>
                          ...
                          <div className='grid grid-cols-1 lg:grid-cols-2 gap-2 overflow-y-auto flex-1'>
                            {activeContent.stats.map((stat, index) => (
                              <div
                                key={index}
                                className='group flex items-center gap-2 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-all duration-200'
                              >
              ...
              >
                <div className='relative bg-gradient-to-br from-slate-700/30 to-slate-800/30 border border-white/10 rounded-xl p-4 backdrop-blur-sm h-[280px] flex items-center justify-center'>
                  {/* Aura */}
            ...
            >
              <div className='relative bg-slate-800/40 border border-white/10 rounded-xl p-3 backdrop-blur-sm'>
                <div className='relative z-10'>
                  <h2 className='text-primary-400 font-mono text-sm font-bold mb-3'>
                    SKILLS
                  </h2>
