        ...
        <div className='relative z-10 p-4'>
          ...
          >
            ...
            <div className='hidden lg:flex items-center gap-4 mr-4'>
              <div className='text-center'>
                <div className='text-xl font-bold text-primary-400'>5+</div>
                <div className='text-white/60 text-xs'>Years</div>
              </div>
              <div className='text-center'>
                <div className='text-xl font-bold text-primary-400'>10K+</div>
                <div className='text-white/60 text-xs'>Devices</div>
              </div>
              <div className='text-center'>
                <div className='text-xl font-bold text-primary-400'>$2M+</div>
          ...
          <div className='relative space-y-4'>
            <div className='relative grid grid-cols-1 lg:grid-cols-12 gap-4 lg:items-start'>
                  ...
                  <div className='relative z-10'>
                    ...
                    <div className='space-y-2'>
                      {services.map((service, index) => (
                        <motion.button
                          key={service.id}
                          className={`group w-full text-left relative p-2 cursor-pointer transition-all duration-200 rounded-lg border ${
              ...
              >
                <div className='relative bg-slate-800/40 border border-white/10 rounded-xl p-4 backdrop-blur-sm h-[320px] flex flex-col'>
                        ...
                        <div className='flex items-center gap-3'>
                          ...
                          {activeContent.level && (
                            <div className='bg-primary-500/10 border border-primary-400/40 rounded-lg px-2 py-1'>
                              <span className='text-primary-300 font-mono text-xs font-bold'>
                                {activeContent.level}%
                              </span>
                            </div>
                          )}
