...
export default function NewAbout() {
  ...
  return (
    <>
      {/* Mobile-only Creative Technologist heading above taglines */}
              ...
              <div className='space-y-3'>
                ...
                <div className='prose prose-invert prose-lg max-w-none'>
                  <p className='text-base sm:text-lg text-zinc-300 leading-relaxed mb-4 sm:mb-5 md:mb-6'>
                    ...
                    technology and creativity. From leading a $500K AWS
                    migration to replace third-party systems and avoid vendor
                    lock-in, to crafting immersive real-time data art and
                    visualizations — my work blends engineering rigor with
