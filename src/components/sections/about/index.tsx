      ...
      <div className='w-full max-w-[95vw] mx-auto px-2 sm:px-4'>
        ...
        <div className='grid lg:grid-cols-[3fr,1fr] gap-6 sm:gap-8 md:gap-12 items-start relative'>
          ...
          >
            ...
            <div className='w-full max-w-64 sm:max-w-72 lg:w-64 sm:lg:w-72 p-3 pb-4 rounded-2xl lg:rounded-b-2xl bg-gradient-to-br from-white/10 via-white/5 to-black/20 backdrop-blur-md border border-white/20 shadow-xl flex flex-col justify-between'>
              <div>
