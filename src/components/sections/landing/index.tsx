...
export default function LandingPage({ onNextSection }: LandingPageProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-20 w-[95%] sm:w-[90%] md:w-[85%] max-w-7xl mx-auto pt-2 sm:pt-3 md:pt-4 overflow-visible pb-28 sm:pb-0 ${showBorders ? 'border-4 border-cyan-500' : ''}`}
      >
