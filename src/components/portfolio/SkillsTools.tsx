...
const skillCategories = [
  {
    ...
    skills: ['AWS', 'IoT Core', 'Kinesis', 'Athena', 'Lambda', 'DynamoDB', 'S3', 'CloudWatch', 'SQS', 'SNS']
  },
  {
    ...
    skills: ['ROS2', 'PX4', 'OTA Updates', 'Telemetry', 'MQTT', 'Protocol Buffers', 'Docker', 'Linux', 'Embedded']
  },
  {
    ...
    skills: ['TouchDesigner', 'React Three Fiber', 'Three.js', 'Kinect', 'MIDI', 'WebGL', 'Shaders', 'Processing', 'Max/MSP']
  },
  {
    ...
    skills: ['Agile', 'Scrum', 'Notion', 'Roadmapping', 'Figma', 'Analytics', 'User Research', 'A/B Testing', 'Jira']
  }
]
...
export default function SkillsTools() {
  return (
    <section id="skills" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-40 right-32 w-1.5 h-1.5 bg-fuchsia-400 rounded-full animate-ping opacity-20" style={{ animationDelay: '1s' }} />
      <div className="absolute bottom-32 left-1/4 w-1 h-1 bg-emerald-400 rounded-full animate-ping opacity-20" style={{ animationDelay: '2s' }} />
      ...
      <div className="container-custom relative z-10">
              ...
              <div className="flex flex-wrap gap-3">
                {category.skills.map((skill, skillIndex) => (
                  ...
                  >
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-r ${category.color} rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-sm -z-10`} />
                  </motion.div>
                ))}
              </div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="w-2 h-2 bg-gradient-to-r from-fuchsia-400 to-emerald-500 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
            <div className="w-1.5 h-1.5 bg-gradient-to-r from-emerald-400 to-cyan-500 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
          </div>
        </motion.div>
      </div>
    </section>
