...
const services = [
  {
    title: 'Cloud & Data',
    description: 'AWS, Kinesis, telemetry ingestion, 10M+ req/day, sub-100ms latency',
    outcomes: 'Reduced infrastructure costs 40% while scaling to handle 3x traffic growth.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10" />
      </svg>
    ),
    technologies: ['AWS', 'Kinesis', 'IoT Core', 'Lambda', 'Athena', 'DynamoDB'],
    color: 'from-cyan-500 to-blue-600'
  },
  {
    title: 'Real-Time Visuals',
    description: 'TouchDesigner, Kinect/MIDI visuals, R3F interactivity',
    outcomes: 'Created immersive experiences for 500+ person events, 99.9% uptime.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
      </svg>
    ),
    technologies: ['TouchDesigner', 'Three.js', 'Kinect', 'MIDI', 'WebGL', 'Shaders'],
    color: 'from-fuchsia-500 to-purple-600'
  },
  {
    title: 'Product Strategy',
    description: 'Sprint planning, roadmap design, MVP scoping',
    outcomes: 'Led 3 product launches, reduced time-to-market by 30% through agile processes.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
      </svg>
    ),
    technologies: ['Agile', 'Scrum', 'Notion', 'Figma', 'Roadmapping', 'Analytics'],
              ...
              <div className="relative p-8 space-y-6">
                ...
                <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                  <p className="text-sm text-zinc-400 leading-relaxed">
                    <span className="text-emerald-400 font-medium">Impact:</span> {service.outcomes}
                  </p>
                </div>
