...
export default function InteractiveElements({
  ...
  return (
    ...
    >
      {/* Enhanced Social Icon Sub-container */}
      <div
      ...
      >
        ...
        <a
          ...
          target='_blank'
          rel='noopener noreferrer'
          className={`flex items-center justify-center gap-3 flex-1 h-14 rounded-full sm:rounded-none bg-black/30 backdrop-blur-md border border-white/20 hover:bg-cyan-400/15 hover:border-cyan-400/40 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-cyan-500/20 pointer-events-auto transform hover:scale-105 hover:-translate-y-1 ${showBorders ? 'border-4 border-magenta-400' : ''}`}
        ...
        <a
          ...
          className={`flex items-center justify-center gap-3 flex-1 h-14 rounded-full sm:rounded-tr-xl bg-black/30 backdrop-blur-md border border-white/20 hover:bg-teal-400/15 hover:border-teal-400/40 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-teal-500/20 pointer-events-auto transform hover:scale-105 hover:-translate-y-1 ${showBorders ? 'border-4 border-orange-400' : ''}`}
      ...
      <motion.div
        className={`flex flex-col gap-3 sm:gap-4 ${showBorders ? 'border-4 border-green-500' : ''}`}
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 1,
      ...
      >
        {/* Mobile: Get in Touch and Continue to site buttons stacked vertically */}
        <div className='flex flex-col sm:hidden gap-3'>
          ...
          <button
            onClick={() => {
              // Use hash-based navigation like the original Continue to site button
