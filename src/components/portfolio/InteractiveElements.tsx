    ...
    >
      ...
      >
        <a
          ...
          className={`flex items-center justify-center gap-2 flex-1 h-12 rounded-tl-lg bg-black/20 backdrop-blur-sm border border-white/20 hover:bg-cyan-400/10 hover:border-cyan-400 transition-all duration-300 shadow-lg hover:shadow-xl pointer-events-auto transform hover:scale-105 ${showBorders ? 'border-4 border-yellow-400' : ''}`}
          aria-label='GitHub profile'
        >
          <svg className='w-6 h-6' fill='#22d3ee' viewBox='0 0 20 20'>
            <path
              fillRule='evenodd'
          ...
          <span className='text-sm font-medium text-cyan-400'>GitHub</span>
        </a>
        <a
          href='https://linkedin.com/in/hartley-leroy'
          target='_blank'
          rel='noopener noreferrer'
          className={`flex items-center justify-center gap-2 flex-1 h-12 rounded-none bg-black/20 backdrop-blur-sm border border-white/20 hover:bg-fuchsia-400/10 hover:border-fuchsia-400 transition-all duration-300 shadow-lg hover:shadow-xl pointer-events-auto transform hover:scale-105 ${showBorders ? 'border-4 border-magenta-400' : ''}`}
          aria-label='LinkedIn profile'
        >
          <svg className='w-6 h-6' fill='#d946ef' viewBox='0 0 24 24'>
            <path d='M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z' />
          </svg>
          <span className='text-sm font-medium text-fuchsia-400'>LinkedIn</span>
        </a>
        <a
          href='mailto:hartley.leroy1997@gmail.com'
          className={`flex items-center justify-center gap-2 flex-1 h-12 rounded-tr-lg bg-black/20 backdrop-blur-sm border border-white/20 hover:bg-emerald-400/10 hover:border-emerald-400 transition-all duration-300 shadow-lg hover:shadow-xl pointer-events-auto transform hover:scale-105 ${showBorders ? 'border-4 border-orange-400' : ''}`}
          ...
          <div className='relative z-10'>
            ...
            <ul className='space-y-3 text-base md:text-lg text-zinc-300 leading-relaxed'>
              ...
              <li className='flex items-center gap-3'>
                <span className='text-gray-400 font-bold'>•</span>
                <span>
                  Programmed smart-lock firmware via NFC energy harvesting.
                </span>
              </li>
              <li className='flex items-center gap-3'>
                <span className='text-gray-400 font-bold'>•</span>
                <span>Led a 6-engineer international dev team.</span>
              </li>
            </ul>
          </div>
        </motion.div>
      ...
      >
        <a
          ...
          className={`flex-1 h-12 px-4 bg-gradient-to-r from-cyan-500 from-10% via-fuchsia-500 via-50% to-fuchsia-500 to-90% text-white font-medium rounded-bl-lg hover:shadow-lg hover:shadow-cyan-500/25 transform hover:scale-105 transition-all duration-300 pointer-events-auto text-center flex items-center justify-center border border-white/20 text-xl ${showBorders ? 'border-4 border-blue-500' : ''}`}
        >
          View Experience
        </a>
        <a
          href='#contact'
          className={`flex-1 h-12 px-4 bg-black/20 backdrop-blur-sm border border-white/20 text-cyan-400 font-medium rounded-br-lg hover:bg-cyan-400/10 hover:border-cyan-400 hover:text-cyan-300 transition-all duration-300 pointer-events-auto text-center flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105 text-xl ${showBorders ? 'border-4 border-purple-500' : ''}`}
        >
          Contact Form
        </a>
      </motion.div>
