...
export default function InteractiveElements({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={`flex flex-col sm:flex-row gap-3 sm:gap-4 ${showBorders ? 'border-4 border-green-500' : ''}`}
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 1,
