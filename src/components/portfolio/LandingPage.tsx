          ...
          >
            ...
            >
              <a
                ...
                className={`flex items-center gap-3 w-full h-10 px-4 rounded-lg bg-black/20 backdrop-blur-sm border border-white/10 hover:bg-black/30 hover:border-white/20 transition-all duration-300 shadow-lg hover:shadow-xl ${showBorders ? 'border-4 border-yellow-400' : ''}`}
              ...
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                className={`flex items-center gap-3 w-full h-10 px-4 rounded-lg bg-black/20 backdrop-blur-sm border border-white/10 hover:bg-black/30 hover:border-white/20 transition-all duration-300 shadow-lg hover:shadow-xl ${showBorders ? 'border-4 border-magenta-400' : ''}`}
              ...
              <a
                ...
                className={`flex items-center gap-3 w-full h-10 px-4 rounded-lg bg-black/20 backdrop-blur-sm border border-white/10 hover:bg-black/30 hover:border-white/20 transition-all duration-300 shadow-lg hover:shadow-xl ${showBorders ? 'border-4 border-orange-400' : ''}`}
              ...
              <motion.div
                className={`flex gap-2 pt-4 ${showBorders ? 'border-4 border-green-500' : ''}`}
              ...
              >
                <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  className={`flex-1 h-10 px-4 bg-gradient-to-r from-cyan-500 to-fuchsia-500 text-white font-medium rounded-lg hover:shadow-lg hover:shadow-cyan-500/25 transform hover:scale-105 transition-all duration-300 pointer-events-auto text-center flex items-center justify-center ${showBorders ? 'border-4 border-blue-500' : ''}`}
                  onError={e => {
                ...
                <a
                  href='#contact'
                  className={`flex-1 h-10 px-4 border border-cyan-400/50 text-cyan-400 font-medium rounded-lg hover:bg-cyan-400/10 hover:border-cyan-400 transition-all duration-300 pointer-events-auto text-center flex items-center justify-center ${showBorders ? 'border-4 border-purple-500' : ''}`}
                >
                  Get in Touch
                </a>
              </motion.div>
