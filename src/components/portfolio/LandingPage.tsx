  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`text-left overflow-visible mt-8 sm:mt-12 md:mt-16 mb-2 sm:mb-3 md:mb-4 ${showBorders ? 'border-4 border-emerald-500' : ''}`}
        >
      ...
      >
        ...
        <div
          className={`grid grid-cols-1 lg:grid-cols-2 w-full gap-2 sm:gap-4 lg:gap-6 items-center justify-items-center ${showBorders ? 'border-4 border-orange-500' : ''}`}
        >
          ...
          <motion.div
            className={`w-full h-full pointer-events-auto -mt-8 sm:-mt-12 md:-mt-16 ${showBorders ? 'border-4 border-lime-500' : ''}`}
