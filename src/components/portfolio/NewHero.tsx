...
const GlitchText = ({ children, className = "" }: { children: React.ReactNode; className?: string }) => {
  return (
    ...
    >
      {children}
      <span 
        className="absolute top-0 left-0 text-cyan-400 opacity-75"
        style={{
      ...
      <span 
        className="absolute top-0 left-0 text-fuchsia-500 opacity-75"
        style={{
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl">
          ...
          >
            ...
            >
              <GlitchText className="bg-gradient-to-r from-fuchsia-500 via-cyan-400 to-emerald-400 bg-clip-text text-transparent">
                Hartley Leroy
              </GlitchText>
            </motion.h1>
            ...
            >
              ...
              <span className="text-emerald-400 font-medium">autonomy</span> — bridging infrastructure and imagination.
            </motion.h2>
            ...
            >
              Cloud & Creative Engineer — robotics fleet management, data pipelines, and real-time visuals.
            </motion.p>
