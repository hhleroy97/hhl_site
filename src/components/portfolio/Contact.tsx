    ...
    <>
      ...
      >
        <div className='max-w-7xl mx-auto w-full px-4'>
          <div className='relative bg-gradient-to-br from-white/[0.08] via-black/50 to-white/[0.03] backdrop-blur-2xl rounded-3xl border border-white/20 p-6 shadow-2xl overflow-hidden min-h-[28rem] sm:min-h-[30rem] md:min-h-[32rem] flex items-center'>
