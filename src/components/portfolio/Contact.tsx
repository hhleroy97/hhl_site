...
export default function ContactFooter() {
  ...
  const copyEmailToClipboard = async () => {
    try {
      await navigator.clipboard.writeText('hartley.leroy1997@gmail.com')
    ...
    <>
      ...
      <AnimatePresence>
        {showCopyAlert && (
          ...
          >
            <div className='bg-gradient-to-r from-emerald-500/90 to-teal-500/90 backdrop-blur-lg border border-emerald-400/20 rounded-xl px-6 py-3 shadow-2xl'>
                    ...
                    <div className='relative z-10 flex items-center justify-between w-full'>
                      ...
                      <div className='relative'>
                        <button
                          ...
                          className='p-2 bg-white/10 hover:bg-white/20 rounded-lg border border-white/20 hover:border-white/30 transition-all duration-200 group'
                        >
                          <svg
                            className='w-4 h-4 text-white group-hover:text-purple-200 transition-colors'
                            fill='none'
                            stroke='currentColor'
                            viewBox='0 0 24 24'
                          >
                        ...
                        {showTooltip && (
                          <div className='absolute -top-10 left-1/2 transform -translate-x-1/2 px-3 py-1 bg-black/90 text-white text-xs rounded-lg shadow-lg whitespace-nowrap z-50'>
                            Copy email address
                          </div>
                        )}
                      </div>
                  ...
                  {submitStatus === 'success' && (
                    ...
                    >
                      ...
                      <p className='text-zinc-300 text-sm'>
                        ...
                        hours with next steps. Check your email for
                        confirmation.
                      </p>
                    </motion.div>
                  )}
